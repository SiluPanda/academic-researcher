...
\title{
  ...
  Title of Your Research Paper: A Comprehensive Approach
}
...
\begin{itemize}
  \item \textbf{Baseline 1}: [description] \cite{baseline1}
  \item \textbf{Baseline 2}: [description] \cite{baseline2}
  \item \textbf{Baseline 3}: [description] \cite{baseline3}
\end{itemize}
...
\begin{figure}[htbp]
\centering
\subfloat[Dataset A]{\includegraphics[width=0.45\linewidth]{fig2a.pdf}}
\hfill
\subfloat[Dataset B]{\includegraphics[width=0.45\linewidth]{fig2b.pdf}}
...
Table~\ ablation-studies the contribution of each component.
